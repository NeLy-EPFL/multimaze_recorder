...
datafolder="${MMRECORDER_LOCAL_PATH:-/mnt/upramdya_data/MD/MultiMazeRecorder/Videos/}"
model_path_ball="${MMRECORDER_SLEAP_MODEL_BALL:-/mnt/upramdya_data/MD/MultiMazeRecorder/Sleap/Labels/models/230602_141343.single_instance.n=108/}"
model_path_fly="${MMRECORDER_SLEAP_MODEL_FLY:-/mnt/upramdya_data/MD/MultiMazeRecorder/Sleap/Labels/Thorax_labels.v001.slp.training_job/models/230825_101219.single_instance/}"
