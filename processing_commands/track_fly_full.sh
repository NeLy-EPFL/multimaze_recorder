...
model_path_fly="${MMRECORDER_SLEAP_MODEL_FLY:-/mnt/upramdya_data/_Tracking_models/Sleap/mazerecorder/FlyTracking/FullBody/models/240809_102156.single_instance.n=421}"
