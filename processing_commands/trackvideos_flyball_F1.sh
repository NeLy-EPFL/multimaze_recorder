...
# Set input and output paths (override via env vars)
datafolder="${MMRECORDER_F1_DATA_PATH:-/mnt/upramdya_data/MD/F1_Tracks/Videos}"
model_path_ball_centroid="${MMRECORDER_SLEAP_MODEL_BALL_CENTROID:-/mnt/upramdya_data/_Tracking_models/Sleap/mazerecorder/BallTracking/models/240926_141251.centroid.n=102}"
model_path_ball_centered_instance="${MMRECORDER_SLEAP_MODEL_BALL_CENTERED:-/mnt/upramdya_data/_Tracking_models/Sleap/mazerecorder/BallTracking/models/240926_151129.centered_instance.n=102}"
model_path_fly="${MMRECORDER_SLEAP_MODEL_FLY:-/mnt/upramdya_data/_Tracking_models/Sleap/mazerecorder/FlyTracking/Thorax/Labels/models/240924_164931.single_instance.n=192}"
