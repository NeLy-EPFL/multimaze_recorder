...
# Default data directory for F1 tracking data
_DEFAULT_DATA_DIR = Path(os.environ.get("MMRECORDER_F1_DATA_PATH", "/mnt/upramdya_data/MD/F1_Tracks/Videos"))
...
def main():
    ...
    parser.add_argument(
        ...
        help="Root directory containing tracking data (default: /mnt/upramdya_data/MD/F1_Tracks/Videos)",
    )
    parser.add_argument(
        "--no-convert-h5",
        action="store_true",
