...
def main():
    ...
    default_dir = os.environ.get("MMRECORDER_LOCAL_PATH", str(Path.home() / "Videos"))
    parser.add_argument("--data-dir", "-d", type=str, default=default_dir,
                       help="Data directory containing folders (default: $MMRECORDER_LOCAL_PATH)")
