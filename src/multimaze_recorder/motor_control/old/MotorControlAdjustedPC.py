...
def goalReached(x, y, arrived, path, towards_rest):
    ...
    if(size_path > 1):  #New target = first node of the shortest path
        ...
        '''
        time.sleep(0.5)
        #BALLS_DESTINATION[8]=[[1561,1350,[2366,13]],[1646,1350,[5656,6122]],[1731,1350,[445465,4654]],[1816,1350,[133,464]],[1900,1350,[4554,4654]],[1985,1350,[14614,163136]]] #middle_middle
        '''
        !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            ENLEVER
        !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
