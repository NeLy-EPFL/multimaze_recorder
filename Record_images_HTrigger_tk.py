...
# Create Tkinter root and label for displaying images
root = Tk()
label = Label(root)
label.pack()
...
while count < duration * fps:
    ...
    # Convert image data to PhotoImage and set image of label
    photoimage = ImageTk.PhotoImage(image=Image.fromarray(CD.image))
...
# Run Tkinter mainloop to display images in window
root.mainloop()